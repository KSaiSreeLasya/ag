...
export default function Admin() {
  ...
  const fetchCounts = async () => {
    try {
      ...
      const [quotes, contacts, apps, jobsList, resourcesList] =
        await Promise.all([
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {addingJob && (
              <div className="space-y-2 mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewJob((s) => ({ ...s, department: e.target.value }))
                  }
                />
                <textarea
                  className="w-full p-2 border"
                  ...
                  onChange={(e) =>
                    setNewJob((s) => ({ ...s, description: e.target.value }))
                  }
                />
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() => {
                        const updated = {
                          title: j.position ?? j.title ?? j.name,
                        };
          ...
          <div className="border rounded p-4 bg-white">
            ...
            <div className="mb-4">
              <Button onClick={() => setAddingResource((s) => !s)}>
            ...
            {addingResource && (
              <div className="space-y-2 mb-4">
                <input
                  ...
                  onChange={(e) =>
                    setNewResource((s) => ({ ...s, title: e.target.value }))
                  }
                />
                <input
                  className="w-full p-2 border"
                  ...
                  onChange={(e) =>
                    setNewResource((s) => ({ ...s, url: e.target.value }))
                  }
                />
                <textarea
                  className="w-full p-2 border"
                  ...
                  onChange={(e) =>
                    setNewResource((s) => ({ ...s, summary: e.target.value }))
                  }
                />
                <div className="flex gap-2">
              ...
              {resources.map((r: any) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      onClick={() => updateResource(r.id, { title: r.title })}
                    >
                      Quick Edit
                    </Button>
                    <Button
